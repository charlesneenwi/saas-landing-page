...
<h2 className="text-2xl pb-4 font-bold text-white mb-4">Three steps to your perfect video</h2>
<p className="text-gray-400 text-lg mb-12">Scenixa makes it easy to create stunning videos in just a few simple steps.</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold mb-2 text-white">Enter your prompt</h3>
                ...
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold mb-2 text-white">AI Generates your video</h3>
                ...
                <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold mb-2 text-white">Download and share</h3>
